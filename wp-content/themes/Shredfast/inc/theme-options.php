...
function twentyeleven_theme_options_help() {
	...
	$help = '<p>' . __( 'Some themes provide customization options that are grouped together on a Theme Options screen. If you change themes, options may change or disappear, as they are theme-specific. Your current theme, Shredfast, provides the following Theme Options:', 'twentyeleven' ) . '</p>' .
			'<ol>' .
...
/**
 * Returns an array of color schemes registered for Shredfast.
 *
 * @since Shredfast 1.0
 */
...
/**
 * Returns an array of layout options registered for Shredfast.
 *
 * @since Shredfast 1.0
 */
...
/**
 * Returns the default options for Shredfast.
 *
 * @since Shredfast 1.0
 */
...
/**
 * Returns the default link color for Shredfast, based on color scheme.
 *
 * @since Shredfast 1.0
 *
...
/**
 * Returns the options array for Shredfast.
 *
 * @since Shredfast 1.0
 */
...
/**
 * Adds Shredfast layout classes to the array of body classes.
 *
 * @since Shredfast 1.0
 */
...
/**
 * Implements Shredfast theme options into Theme Customizer
 *
