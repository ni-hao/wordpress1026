<?php
/**
 * Makes a custom Widget for displaying Aside, Link, Status, and Quote Posts available with Shredfast
 *
...
class Twenty_Eleven_Ephemera_Widget extends WP_Widget {
	...
	function Twenty_Eleven_Ephemera_Widget() {
		...
		$this->WP_Widget( 'widget_twentyeleven_ephemera', __( 'Shredfast Ephemera', 'twentyeleven' ), $widget_ops );
